...
print('AD_PLAN_PERSISTENCE_ACK_FINALIZE_OK: save=validation+normalization+audit+cloud-ack-before-success; standalone-editor=preserved; failure=field-level+attempt-audit-rollback+rollback-persisted; concurrency=client+campaign+field-authority-preserved; missing-barrier=fail-closed; save-queue=shared-flushSave; app=' + changed[0][0] + ':' + changed[0][1])
