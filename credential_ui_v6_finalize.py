...
# Final safety assertions before event liveness is attached.
for forbidden in (
    "crm_client_credential_status",
    "growthops_credential_status_v2",
...
# Fold the former v6-event liveness stage into the final runtime stage.
...
if index_hash!='14bcf8c660fbd7dc8721237af00e100fea1584f3193fe6fa4a0b584454ea03f2':
    raise SystemExit('Consolidated credential runtime changed the production index baseline: '+index_hash)
if security_hash!='366c4c2dd3e649efc2c153382eac5009a593ffd00e4b24c20d8de799d48d8cba':
    raise SystemExit('Consolidated credential runtime changed the production security baseline: '+security_hash)
print('CREDENTIAL_UI_RUNTIME_FINALIZE_OK: reveal_transport=v5-single-value; index='+index_hash+'; security='+security_hash)
