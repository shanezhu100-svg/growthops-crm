...
# When a concrete SOP client is selected but no account is active, show the
# executable accounts directly in the page, grouped by Facebook and TikTok.
# This is the single canonical account-card implementation; the top-right select
# remains only as a fast switch.
...
print(
    'MODULE_HOME_NAVIGATION_FINALIZE_OK: authority=navigateTo; sentinel-zero=valid; wrappers=removed; sop=all-clients+grouped-account-options; '
