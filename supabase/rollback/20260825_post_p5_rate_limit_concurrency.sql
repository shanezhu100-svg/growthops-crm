-- Exact rollback for 20260825_post_p5_rate_limit_concurrency.sql.
-- Restores the three accepted predecessor function definitions and preserves the
-- Post-P5 EXECUTE boundary. It intentionally restores exception-based unlock/
-- reveal rejection semantics because rollback must reproduce the prior state.
