...
function baseSubject(overrides={}){
  ...
  const subject={
    ...
    contractDueReminderStage:(client,date)=>date?{reminderIndex:2}:null,autoDueReminderStage:date=>date?{reminderIndex:2}:null,financeReceivableUnpaid:r=>Number(r.unpaid??r.amount??0),
