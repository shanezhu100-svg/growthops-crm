...
assert.equal(Object.keys(expectedHeaders).length, 7, 'expected seven browser hardening headers');
...
console.log('CLOUDFLARE_FUNCTION_SECURITY_HEADERS_TESTS_OK: source=vercel.json; responses=method+origin+config-failure; headers=7; cache=no-store; parity=exact');
