...
if tokens != ["'self'"]:
    raise SystemExit('INLINE_SCRIPT_STATIC_POLICY_FAILED: script-src must be same-origin only')
if "'unsafe-inline'" in script_part or "'unsafe-eval'" in script_part:
    raise SystemExit('INLINE_SCRIPT_STATIC_POLICY_FAILED: unsafe script capability returned')
