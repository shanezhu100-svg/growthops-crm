...
print('PRODUCTION_AUTH_COPY_OUTPUT_TESTS_OK: stale-local-copy=absent; server-auth-copy=present; same-origin-api-copy=present; httponly-session-copy=present; current-login-copy=httponly')
